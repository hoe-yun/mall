...
<body>
  ...
  <jsp:include page="/inc/menu.jsp"></jsp:include>
                    ...
                    <div class="checkout__order">
                            <div class="row">
                                <div class="col-lg-12">
                                    ...
                                    <input class="form-control my-2" id="address" type="text" placeholder="기본배송지주소">
    ...
    <script>
    //가입버튼 누르면진행 pw 밸리데이션 후 진행
    $('#createCustomerAccountBtn').click(function () {
		if($('#pw').val() != $('#pwcheck').val()){
			$('#pwAlert').text('신규 비밀번호 확인이 일치하지 않습니다.');
		}else{
			$('#pwAlert').text('');
			$.post("customerApiController.jsp",{ //post비동기요청
