...
) ENGINE=InnoDB AUTO_INCREMENT=79300 DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;

-- 테이블 데이터 mall.cart:~2 rows (대략적) 내보내기
REPLACE INTO `cart` (`cart_no`, `goods_no`, `customer_no`, `quantity`, `createdate`, `updatedate`) VALUES
	(70887, 2, 1, 2, '2023-11-08 11:30:57', '2023-11-08 11:30:57'),
	(70890, 3, 1, 1, '2023-11-08 12:00:24', '2023-11-08 12:00:24');
...
REPLACE INTO `customer` (`customer_no`, `customer_id`, `customer_pw`, `createdate`, `updatedate`, `active`) VALUES
...
REPLACE INTO `customer_addr` (`customer_addr_no`, `customer_no`, `address`, `createdate`, `updatedate`) VALUES
...
REPLACE INTO `customer_detail` (`customer_no`, `customer_name`, `customer_phone`, `createdate`, `updatedate`) VALUES
...
REPLACE INTO `customer_pw_history` (`customer_pw_history_no`, `customer_no`, `customer_pw`, `createdate`) VALUES
...
REPLACE INTO `goods` (`goods_no`, `goods_title`, `goods_price`, `soldout`, `goods_memo`, `createdate`, `updatedate`) VALUES
	(1, '에어맥스95', 130000, 'Y', '나이키 에어맥스95', '2023-11-01 16:28:37', '2023-11-01 16:28:37'),
	(2, '에어맥스97', 140000, 'Y', '나이키 에어맥스97', '2023-11-01 16:28:37', '2023-11-01 16:28:37'),
	(3, '에어포스', 120000, 'Y', '나이키 에어포스 된장', '2023-11-01 16:28:37', '2023-11-01 16:28:37'),
	(4, '에어조던', 130000, 'Y', '나이키 에어조던', '2023-11-01 16:28:37', '2023-11-01 16:28:37'),
	(5, '코르테즈', 110000, 'Y', '나이키 코르테즈', '2023-11-01 16:28:37', '2023-11-01 16:28:37'),
	(6, '루나글라이드', 120000, 'Y', '나이키 루나글라이드', '2023-11-01 16:28:37', '2023-11-01 16:28:37'),
	(7, '머큐리얼베이퍼', 130000, 'Y', '나이키 머큐리얼베이퍼', '2023-11-01 16:28:37', '2023-11-01 16:28:37'),
	(8, '업템포', 150000, 'Y', '나이키 업템포', '2023-11-01 16:28:37', '2023-11-01 16:28:37'),
	(9, '인터내셔널리스트', 99000, 'Y', '나이키 인터내셜리스트', '2023-11-01 16:28:37', '2023-11-01 16:28:37'),
	(10, '프리런', 85000, 'Y', '나이키 프리런', '2023-11-01 16:28:37', '2023-11-01 16:28:37'),
...
REPLACE INTO `goods_img` (`goods_no`, `filename`, `origin_name`, `content_type`, `createdate`, `updatedate`) VALUES
	(1, '에어맥스95_디테일01.png', '에어맥스95_디테일01.png', 'image/png', '2023-11-03 12:25:31', '2023-11-03 12:25:31');
...
REPLACE INTO `manager` (`manager_no`, `manager_id`, `manager_pw`, `manager_name`, `createdate`, `updatedate`, `active`) VALUES
...
REPLACE INTO `manager_pw_history` (`manager_pw_history_no`, `manager_no`, `manager_pw`, `createdate`) VALUES
...
REPLACE INTO `nostice` (`notice_no`, `manager_no`, `notice_title`, `notice_content`, `createdate`, `updatedate`) VALUES
...
REPLACE INTO `question` (`question_no`, `goods_no`, `customer_no`, `question_title`, `question_content`, `createdate`, `updatedate`) VALUES
...
REPLACE INTO `question_comment` (`question_comment_no`, `question_no`, `manager_no`, `comment`, `createdate`, `updatedate`) VALUES
